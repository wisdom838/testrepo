	...
	authKey = this.conf.get('auth-key');
      ...
      saveMenu(param){
		...
		headers.append(this.hmsauthKey,this.hmsaccessKey);
            ...
            this.url = this.host+"hospitality/addmenucategory";
      ...
      updateMenu(param){
		...
		headers.append(this.hmsauthKey,this.hmsaccessKey);
            headers.append("Content-Type", "application/json");
            this.url = this.host+"hospitality/setmenucategory";
		return this._http.post(this.url, JSON.stringify(param), {headers: headers}).map(res=> res.json());	 
	}
      ...
      getMenu(param){
		...
		headers.append(this.hmsauthKey,this.hmsaccessKey);
            headers.append("Content-Type", "application/json");
            this.url = this.host+"hospitality/getmenucategory";
            return this._http.post(this.url, JSON.stringify(param), {headers: headers}) .map(res=> res.json());
	}
      ...
      DeleteMenu(param){
		...
		headers.append(this.hmsauthKey,this.hmsaccessKey);
            headers.append("Content-Type", "application/json");
		this.url = this.host+"hospitality/delmenucategory";
