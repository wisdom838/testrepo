...
@Component({
  ...
  providers:[MenuCategoryService,SubMenuCategoryService,FooditemmasterService,Chartnames]
})
export class FoodchartComponent implements OnInit {
  ...
  constructor(private _menuservice:MenuCategoryService, private _submenuservice:SubMenuCategoryService, private _itemservice:FooditemmasterService,private _chartname:Chartnames) { 
  ...
  saveValues(data){
    ...
    this.responsedata.foundation_chart=this.dataarry;
    //console.log("updated key:" + this.dataarry);
